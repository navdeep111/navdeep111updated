...
import experiences from "@/data/experiences2";

const HomeSection3_2 = ({ id }: { id: string }) => {
  return (
    <ResponsiveBox
    ...
    >
      <ConstraintedBox classNames="p-4 py-16">
        <SectionTitle>Volunteering and other Experiences</SectionTitle>
