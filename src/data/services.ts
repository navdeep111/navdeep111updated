...
const services: IServiceItem[] = [
  ...
  //   description:
  //     "I design intuitive and visually appealing user interfaces for web and mobile apps. Utilizing cutting-edge design principles and tools, I ensure effortless navigation, beautiful layouts, and user-friendly interactions that support your business objectives. Experience outstanding usability and client satisfaction with every design.",
  // },
  {
    id: 2,
